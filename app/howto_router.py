...
_HOWTO_SECTIONS: list[dict] = [
    ...
    # ── Subsurface Data Models ────────────────────────────────────────
    {
        ...
        "items": [
            ...
            {
                "slug": "_ext_seismic_interp",
                "external_url": "https://community.opengroup.org/osdu/platform/domain-data-mgmt-services/reservoir/home/-/blob/main/docs/SeismicInterpretation.md",
                "title": "Seismic Interpretation ↗",
                "desc": "Data model, RDDMS patterns & OSDU mapping (RDDMS Home)",
            },
            {
                "slug": "strat-column",
                "file": "StratColumn.md",
            ...
            {
                "slug": "_ext_resqml_osdu_guide",
                "external_url": "https://community.opengroup.org/osdu/platform/domain-data-mgmt-services/reservoir/home/-/blob/main/docs/ResqmlOsduGuide.md",
                "title": "RESQML ↔ OSDU Manifest Guide ↗",
                "desc": "Decision trees, type mapping, authoring guide & CRS enrichment (RDDMS Home)",
            },
        ],
    },
    # ── Infrastructure ─────────────────────────────────────────────
    {
        ...
        "items": [
            ...
            {
                "slug": "_ext_crs_handler",
                "external_url": "https://community.opengroup.org/osdu/platform/domain-data-mgmt-services/reservoir/home/-/blob/main/docs/CrsHandler.md",
                "title": "CRS Guide ↗",
                "desc": "RESQML ⇄ OSDU coordinate reference systems (RDDMS Home)",
            },
            {
                "slug": "pws",
                "file": "PWS.md",
